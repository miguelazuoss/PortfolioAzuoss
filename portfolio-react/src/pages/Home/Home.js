...
function Home() {
  ...
  return (
    <div>
    <div ref={ref} className='ContainerMain'>
      <div className={inView ? 'ContainerAboutMe visible' : 'ContainerAboutMe init-hidden'}>
      ...
      <div className={inView ? 'ContainerPhoto visible' : 'ContainerPhoto init-hidden'}>
